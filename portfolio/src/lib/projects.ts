...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    desc: "Classification model predicting stroke risk from patient health data. Python, RapidMiner.",
    tracks: ["data"],
  },
  {
    title: "Credit Card Fraud Detection",
    metric: "Classification",
    desc: "Classification model flagging fraudulent transactions from transaction data. Python, RapidMiner.",
    tracks: ["data"],
  },
  {
    title: "Loan Acceptance Model",
    metric: "Decision tree",
    desc: "Decision tree model predicting loan approval outcomes from applicant data. Python, RapidMiner.",
    tracks: ["data"],
  },
  {
    title: "Tax Evasion Prediction",
    metric: "Classification",
    desc: "Classification model identifying likely tax evasion patterns from financial indicators. Python, RapidMiner.",
    tracks: ["data"],
  },
  {
    title: "Music & Mental Health Analysis",
    metric: "Correlation analysis",
    desc: "Correlation analysis exploring the relationship between music listening habits and self-reported mental health, using the MxMH dataset. Python, exploratory data analysis.",
    tracks: ["data"],
  },
  {
    title: "Nutritional Value Calculator",
    metric: "Image → calories",
    desc: "Full-stack app estimating calories and nutrition from a photo of food: Python/ML backend for image-based estimation, web frontend for the user-facing app.",
    tracks: ["sw"],
  },
  {
  ...
  },
  {
    ...
    metric: "Bilingual site",
    desc: "Bilingual corporate website built for Tamimi Global (TAFGA) using React and i18next, improving mobile responsiveness and SEO.",
    tracks: ["sw"],
  },
];
